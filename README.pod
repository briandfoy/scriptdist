...
CPAN web interfaces, such as L<CPAN Search|http://search.cpan.org/dist/App-scriptdist> or 
L<MetaCPAN|http://www.metacpan.org/module/App::scriptdist>:

=over 4

=item *	L<http://search.cpan.org/dist/App-scriptdist>

=item *	L<http://www.metacpan.org/module/App::scriptdist>
